...
//    @Test
//    public void testRegisterAdmin() throws InvalidEmailPasswordException {
...
//		
//		// mock the Pattern.matches() method calls
//	    when(Pattern.matches(anyString(), eq(admin.getEmailId()))).thenReturn(true);
//	    when(Pattern.matches(anyString(), eq(admin.getPassword()))).thenReturn(true);
//
