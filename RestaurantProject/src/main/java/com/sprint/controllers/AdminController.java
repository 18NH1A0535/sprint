...
public class AdminController {
	...
	// Display a list of customers ordered by frequency of visits
	  ...
	  @GetMapping("/bookings/{tableNumber}/{date}")
	    public ResponseEntity<List<String>> displayTableBookings(@PathVariable("tableNumber") int tableNumber, @PathVariable("date") @DateTimeFormat(pattern="yyyy-MM-dd") LocalDate date) throws BookingNotFoundException {
